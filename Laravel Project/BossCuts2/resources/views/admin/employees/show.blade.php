...
<div role="tabcard" class="tab-pane active" id="workinghours">
...
<td>{{ isset($working_hour->employee) ? $working_hour->employee->last_name : '' }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.working_hours.show',[$working_hour->id]) }}" class="btn btn-xs btn-primary">@lang('barberadmin.qa_view')</a>
                                    @endcan
                                    @can('working_hour_edit')
                                    <a href="{{ route('admin.working_hours.edit',[$working_hour->id]) }}" class="btn btn-xs btn-info">@lang('barberadmin.qa_edit')</a>
                                    @endcan
...
<div role="tabcard" class="tab-pane " id="appointments">
...
<td>{{ isset($appointment->employee) ? $appointment->employee->last_name : '' }}</td>
        ...
        @endif
            ...
            <a href="{{ route('admin.employees.index') }}" class="btn btn-default">@lang('barberadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop